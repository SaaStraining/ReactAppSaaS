      ...
      <div className="w-full">
        <div className="w-5/6 mx-auto  mt-24 mb-7 ">
          <form action="" className="flex mx-auto justify-around">
            ...
            <div className="w-44 mr-1">
              ...
              <input
                type="number"
                className= " focus:border-primary   focus:ring-0  w-full h-10 rounded-md border-gray-300"
                placeholder="%"
              />
            </div>
            <div className="mr-1">
        ...
        <div className="w-5/6 mx-auto">
          <button
            ...
            className="float-left   w-36 rounded-md px-3 py-2 bg-gray-500 text-white"
          >
            Retour
          </button>
          <button
            onClick={this.Continue}
            className="float-right  w-36 rounded-md px-3 py-2 bg-primary  text-white "
          >
            Suivant
          </button>
        </div>
