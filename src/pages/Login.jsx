    ...
    <div className='Login-container w-full flex text-center'>
        <div className='flex flex-col w-7/12  m-0   pt-5 '>
            <div className='flex justify-between mx-16 '>
                ...
                <a href="" className='log_ret  w-24  px-3 py-1 rounded-2xl border border-blue-500 hover:text-white'>
                    Retour
                </a>
            </div>
            <div className=" mt-40 mx-10 ">
                ...
                <div className='form-container border'>
                    <form className='log_inner_form '>
                        ...
                        <button type='submit' className='text-white mt-8 w-2/5 h-14 text-xl rounded-full   hover:shadow-none'>Se connecter</button>
                    </form>
                </div>
            </div>
        </div>
